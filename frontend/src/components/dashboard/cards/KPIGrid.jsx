      ...
      {items.map((card) => {
        ...
        return (
          ...
          <div className="mt-2 sm:mt-3 flex items-center justify-between">
            <span className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-900 group-hover:text-[#4C763B] transition-colors">{card.id === 'completed-aptitude' ? 186 : card.value}</span>
            <span 
